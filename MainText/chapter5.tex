...
\end{figure}
%
The time at which the intrinsic emittances diverge from the apparent emittances has been pushed later in injection — in this case, near turn 200 — and the resulting emittance evolution more closely resembles the measurements in Fig.~\ref{fig:exp3_emittances}. 
