...
%
\begin{equation}
    H = \frac{1}{2}{x'}^2 + \frac{1}{2}{y'}^2 + \frac{1}{2}k_{x}x^2 + \frac{1}{2}k_{y}y^2 + \frac{q}{m\gamma^3\beta^2c^2}\Phi
\end{equation}
%
The space charge potential $\Phi$ is determined from the Poisson equation:
%
