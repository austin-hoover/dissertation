...
%-------------------------------------------------------------------------------
% Final version for thesis submission
\documentclass[final]{oist_thesis} 
...
\usepackage{graphbox}
\usepackage{parskip} % skip line instead of indent.
...
% Change heading in table of contents
...
% Don't apply parskip package to the TOC. The parskip package says that it won't affect the TOC, and I also tried \usepackage[tocskip=0pt]{parskip}, but that didnt' work.
\newenvironment{toc}{
...
% \addtocontents{toc}{\vspace{2em}} % Add a gap in the Contents, for aesthetics
\unnumberedchapterintoc{Bibliography} % Title of the unnumbered chapter
